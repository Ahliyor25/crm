...
func (p provider) Get(target entities.ProductPriceHistory) (data entities.ProductPriceHistory, err error) {
	...
	if err != nil {
		...
		}).Error("An error occurred while retrieving ProductPriceHistory data")
